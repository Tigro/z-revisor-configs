...
#       Default is z6-updates.img
#   to define this resultant directory and image file to the revisor.conf file
#       Defined in "revisor.conf" as updates_img 
#       Default for updates_img in "/etc/revisor/revisor.conf" is /etc/revisor/Z6/images/z6-updates.img
...
if [ -z $UPDATES_IMG_DIR ] ; then
        UPDATES_IMG_DIR="/etc/revisor/Z6/images"
fi

if [ -z $UPDATES_IMG ] ; then
        UPDATES_IMG="z6-updates.img"
fi
