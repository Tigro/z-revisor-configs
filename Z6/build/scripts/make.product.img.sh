...
if [ -z $PRODUCT_IMG_DIR ] ; then
        PRODUCT_IMG_DIR="/etc/revisor/Z6/images"
fi

if [ -z $PRODUCT_IMG ] ; then
        PRODUCT_IMG="z6-product.img"
fi
